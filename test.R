...
#크롤링한 결과를 저장하는 매트릭스
naverresult2 <- matrix(nrow = 5, ncol = 2)
#1
mystr <- str_locate(channel[1], "title")
mystr2 <- str_locate(channel[1], "상")
name <- str_sub(channel[1], start = mystr[2]+1, end = mystr2[1]-1)
...
#크롤링한 결과를 저장하는 매트릭스
naverresult3 <- matrix(nrow = 5, ncol = 2)
#1
mystr <- str_locate(channel[1], "title")
mystr2 <- str_locate(channel[1], "상")
name <- str_sub(channel[1], start = mystr[2]+1, end = mystr2[1]-1)
...
#크롤링한 결과를 저장하는 매트릭스
naverresult4 <- matrix(nrow = 5, ncol = 2)
#1
mystr <- str_locate(channel[1], "title")
mystr2 <- str_locate(channel[1], "상")
name <- str_sub(channel[1], start = mystr[2]+1, end = mystr2[1]-1)
...
#크롤링한 결과를 저장하는 매트릭스
naverresult5 <- matrix(nrow = 5, ncol = 2)
#1
mystr <- str_locate(channel[1], "title")
mystr2 <- str_locate(channel[1], "상")
name <- str_sub(channel[1], start = mystr[2]+1, end = mystr2[1]-1)
...
#크롤링한 결과를 저장하는 매트릭스
naverresult6 <- matrix(nrow = 5, ncol = 2)
#1
mystr <- str_locate(channel[1], "title")
mystr2 <- str_locate(channel[1], "상")
name <- str_sub(channel[1], start = mystr[2]+1, end = mystr2[1]-1)
...
#크롤링한 결과를 저장하는 매트릭스
naverresult7 <- matrix(nrow = 5, ncol = 2)
#1
mystr <- str_locate(channel[1], "title")
mystr2 <- str_locate(channel[1], "상")
name <- str_sub(channel[1], start = mystr[2]+1, end = mystr2[1]-1)
...
#크롤링한 결과를 저장하는 매트릭스
naverresult8 <- matrix(nrow = 5, ncol = 2)
#1
mystr <- str_locate(channel[1], "title")
mystr2 <- str_locate(channel[1], "상")
name <- str_sub(channel[1], start = mystr[2]+1, end = mystr2[1]-1)
...
#크롤링한 결과를 저장하는 매트릭스
naverresult9 <- matrix(nrow = 5, ncol = 2)
#1
mystr <- str_locate(channel[1], "title")
mystr2 <- str_locate(channel[1], "상")
name <- str_sub(channel[1], start = mystr[2]+1, end = mystr2[1]-1)
...
#크롤링한 결과를 저장하는 매트릭스
naverresult10 <- matrix(nrow = 5, ncol = 2)
#1
mystr <- str_locate(channel[1], "title")
mystr2 <- str_locate(channel[1], "상")
name <- str_sub(channel[1], start = mystr[2]+1, end = mystr2[1]-1)
