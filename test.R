...
url = "http://shopping.naver.com/search/all.nhn?query=%EC%9A%94%EC%9A%94%EC%89%AC%20%ED%8C%A8%EB%93%9C%2050%EB%A7%A4%201%201&pagingIndex=1&pagingSize=40&viewType=list&sort=price_asc&frm=NVSHATC"
myurl <- gsub(" ", "", dotcomresult[7,1])
naverurl = paste0("http://shopping.naver.com/search/all.nhn?query=", myurl, "&pagingIndex=1&pagingSize=40&viewType=list&sort=price_asc&frm=NVSHATC")
SOURCE = getURL(url)
