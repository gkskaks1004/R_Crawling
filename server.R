...
shinyServer(function(input, output, session) {
  ...
  colnames(naverresult2) <- c("채널명", "가격")
  colnames(naverresult3) <- c("채널명", "가격")
  colnames(naverresult4) <- c("채널명", "가격")
  colnames(naverresult5) <- c("채널명", "가격")
  colnames(naverresult6) <- c("채널명", "가격")
  colnames(naverresult7) <- c("채널명", "가격")
  colnames(naverresult8) <- c("채널명", "가격")
  colnames(naverresult9) <- c("채널명", "가격")
  colnames(naverresult10) <- c("채널명", "가격")
  #셀렉트 버튼 설정하여
  #네이버 쇼핑 상품 크롤링
